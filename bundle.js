 ...
 */
},{"./mock-dom-source":3,"./render-dom":4,"./render-html":5,"./virtual-hyperscript":8,"./virtual-hyperscript-svg":7,"hyperscript-helpers":9}],2:[function(require,module,exports){
"use strict";function createListener(e){var n=e.element,r=e.eventName,t=e.handler,a=e.useCapture;if(n.addEventListener)return n.addEventListener(r,t,a),disposableCreate(function(){n.removeEventListener(r,t,a)});throw new Error("No listener found")}function createEventListener(e){var n=e.element,r=e.eventName,t=e.handler,a=e.useCapture,s=new CompositeDisposable;if(Array.isArray(n))for(var o=0,u=n.length;u>o;o++)s.add(createEventListener({element:n[o],eventName:r,handler:t,useCapture:a}));else n&&s.add(createListener({element:n,eventName:r,handler:t,useCapture:a}));return s}function fromEvent(e,n,r){var t=arguments.length<=3||void 0===arguments[3]?!1:arguments[3];return new AnonymousObservable(function(a){return createEventListener({element:e,eventName:n,handler:function(){r(arguments[0]),a.onNext(arguments[0])},useCapture:t})}).share()}var Rx=require("rx"),disposableCreate=Rx.Disposable.create,CompositeDisposable=Rx.CompositeDisposable,AnonymousObservable=Rx.AnonymousObservable;module.exports=fromEvent;

},{"rx":11}],3:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function getEventsStreamForSelector(e){return function(r){for(var t in e)if(e.hasOwnProperty(t)&&t===r)return e[t];return emptyStream}}function mockDOMSource(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return{select:function(r){for(var t in e)if(e.hasOwnProperty(t)&&t===r)return{observable:emptyStream,events:getEventsStreamForSelector(e[t])};return{observable:emptyStream,events:function(){return emptyStream}}}}}Object.defineProperty(exports,"__esModule",{value:!0});var _rx=require("rx"),_rx2=_interopRequireDefault(_rx),emptyStream=_rx2["default"].Observable.empty();exports["default"]=mockDOMSource,module.exports=exports["default"];

},{"rx":11}],4:[function(require,module,exports){
"use strict";function isElement(e){return"object"==typeof HTMLElement?e instanceof HTMLElement||e instanceof DocumentFragment:e&&"object"==typeof e&&null!==e&&(1===e.nodeType||11===e.nodeType)&&"string"==typeof e.nodeName}function wrapTopLevelVTree(e,r){var t=e.properties.id,n=void 0===t?"":t,o=e.properties.className,a=void 0===o?"":o,i=n===r.id,s=a===r.className,c=e.tagName.toUpperCase()===r.tagName;if(i&&s&&c)return e;var u={};return r.id&&(u.id=r.id),r.className&&(u.className=r.className),VDOM.h(r.tagName,u,[e])}function makeDiffAndPatchToElement$(e){return function(r){var t=_slicedToArray(r,2),n=t[0],o=t[1];if("undefined"==typeof o)return Rx.Observable.empty();var a=wrapTopLevelVTree(n,e),i=wrapTopLevelVTree(o,e);return e=VDOM.patch(e,VDOM.diff(a,i)),Rx.Observable.just(e)}}function renderRawRootElem$(e,r){var t=makeDiffAndPatchToElement$(r);return e.flatMapLatest(transposeVTree).startWith(VDOM.parse(r)).pairwise().flatMap(t)}function isolateSource(e,r){return e.select(".cycle-scope-"+r)}function isolateSink(e,r){return e.map(function(e){var t=e.properties.className,n=void 0===t?"":t;if(-1===n.indexOf("cycle-scope-"+r)){var o=(n+" cycle-scope-"+r).trim();e.properties.className=o}if(e.properties.attributes){var a=e.properties.attributes["class"]||"";if(-1===a.indexOf("cycle-scope-"+r)){var i=(a+" cycle-scope-"+r).trim();e.properties.attributes["class"]=i}}return e})}function makeIsStrictlyInRootScope(e,r){var t=function(e){var t=e.match(/cycle-scope-(\S+)/);return t&&-1===r.indexOf("."+e)},n=function(e){var t=e.match(/cycle-scope-(\S+)/);return t&&-1!==r.indexOf("."+e)};return function(r){for(var o=r;null!==o;o=o.parentElement){if(e.indexOf(o)>=0)return!0;var a=String.prototype.split,i=o.classList||a.call(o.className," ");if(Array.prototype.some.call(i,n))return!0;if(Array.prototype.some.call(i,t))return!1}return!0}}function makeEventsSelector(e,r){return function(t){var n=arguments.length<=1||void 0===arguments[1]?!1:arguments[1];if("string"!=typeof t)throw new Error("DOM driver's events() expects argument to be a string representing the event type to listen for.");var o=r(t);return e.flatMapLatest(function(e){return 0===e.length?Rx.Observable.empty():fromEvent(e,t,o.add,n)}).share().subscribe(o.stream),o.stream}}function makeElementSelector(e,r){return function(t){function n(e){return r(t+","+e)}if("string"!=typeof t)throw new Error("DOM driver's select() expects the argument to be a string as a CSS selector");var o=this.namespace,a=":root"===t.trim()?e:e.map(function(e){var r=Array.isArray(e)?e:[e];return r.map(function(e){var r=""+o.join(" ")+t;if(matchesSelector(e,r))return[e];var n=(o.join(" ")+" "+t).trim(),a=e.querySelectorAll(n);return Array.prototype.slice.call(a)}).reduce(function(e,r){return e.concat(r)},[]).filter(makeIsStrictlyInRootScope(r,o.concat(t)))});return{observable:a,namespace:o.concat(t),select:makeElementSelector(a,n),events:makeEventsSelector(a,r(t)),isolateSource:isolateSource,isolateSink:isolateSink}}}function validateDOMSink(e){if(!e||"function"!=typeof e.subscribe)throw new Error("The DOM driver function expects as input an Observable of virtual DOM elements")}function makeDOMDriver(e,r){function t(e){return function(r){function t(t){u[e][r].events.push({event:t,time:new Date})}return"undefined"==typeof u[e]&&(u[e]={}),"undefined"==typeof u[e][r]&&(u[e][r]={stream:new Rx.Subject,events:[]}),{add:t,stream:u[e][r].stream}}}function n(e){validateDOMSink(e);var r=renderRawRootElem$(e,a).startWith(a).doOnError(c).replay(null,1),n=r.connect();return{namespace:[],select:makeElementSelector(r,t),dispose:n.dispose.bind(n),isolateSource:isolateSource,isolateSink:isolateSink,history:function(){return u}}}function o(e){function r(e,r){function t(){r.stream.onNext(e.event)}n.scheduleAbsolute({},e.time,t)}function t(e){return function(t){r(t,e)}}var n=new Rx.HistoricalScheduler;for(var o in e)if(e.hasOwnProperty(o)){var a=e[o];for(var i in a)if(a.hasOwnProperty(i)){var s=a[i];s.events.forEach(t(s))}}n.start()}var a="string"==typeof e?document.querySelector(e):e;if("string"==typeof e&&null===a)throw new Error("Cannot render into unknown element `"+e+"`");if(!isElement(a))throw new Error("Given container is not a DOM element neither a selector string.");var i=r||{},s=i.onError,c=void 0===s?console.error.bind(console):s;if("function"!=typeof c)throw new Error("You provided an `onError` to makeDOMDriver but it was not a function. It should be a callback function to handle errors.");var u={};return n.replayHistory=o,n}var _slicedToArray=function(){function e(e,r){var t=[],n=!0,o=!1,a=void 0;try{for(var i,s=e[Symbol.iterator]();!(n=(i=s.next()).done)&&(t.push(i.value),!r||t.length!==r);n=!0);}catch(c){o=!0,a=c}finally{try{!n&&s["return"]&&s["return"]()}finally{if(o)throw a}}return t}return function(r,t){if(Array.isArray(r))return r;if(Symbol.iterator in Object(r))return e(r,t);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),Rx=require("rx"),fromEvent=require("./fromevent"),VDOM={h:require("./virtual-hyperscript"),diff:require("virtual-dom/diff"),patch:require("virtual-dom/patch"),parse:"undefined"!=typeof window?require("vdom-parser"):function(){}},_require=require("./transposition"),transposeVTree=_require.transposeVTree,matchesSelector=void 0;try{matchesSelector=require("matches-selector")}catch(err){matchesSelector=function(){}}module.exports={isElement:isElement,wrapTopLevelVTree:wrapTopLevelVTree,makeDiffAndPatchToElement$:makeDiffAndPatchToElement$,renderRawRootElem$:renderRawRootElem$,validateDOMSink:validateDOMSink,makeDOMDriver:makeDOMDriver};

},{"./fromevent":2,"./transposition":6,"./virtual-hyperscript":8,"matches-selector":10,"rx":11,"vdom-parser":12,"virtual-dom/diff":27,"virtual-dom/patch":34}],5:[function(require,module,exports){
...
},{"./transposition":6,"rx":11,"vdom-to-html":16}],6:[function(require,module,exports){
...
},{"rx":11,"virtual-dom/vnode/vnode":53}],7:[function(require,module,exports){
...
},{"./virtual-hyperscript":8,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":41,"virtual-dom/virtual-hyperscript/svg-attribute-namespace":45,"x-is-array":58}],8:[function(require,module,exports){
...
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":42,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":43,"virtual-dom/virtual-hyperscript/parse-tag.js":44,"virtual-dom/vnode/is-thunk":47,"virtual-dom/vnode/is-vhook":48,"virtual-dom/vnode/is-vnode":49,"virtual-dom/vnode/is-vtext":50,"virtual-dom/vnode/is-widget":51,"virtual-dom/vnode/vnode.js":53,"virtual-dom/vnode/vtext.js":55,"x-is-array":58}],9:[function(require,module,exports){
'use strict';
...
},{"_process":62}],12:[function(require,module,exports){
...
},{"./namespace-map":13,"./property-map":14,"virtual-dom/vnode/vnode":53,"virtual-dom/vnode/vtext":55}],13:[function(require,module,exports){
...
},{"./property-config":25,"escape-html":17}],16:[function(require,module,exports){
var escape = require('escape-html');
...
},{"./vendor/camel-case-regexp":20,"./vendor/non-word-regexp":21,"./vendor/trailing-digit-regexp":22,"lower-case":18}],20:[function(require,module,exports){
...
},{"sentence-case":19}],24:[function(require,module,exports){
...
},{"./vtree/diff.js":57}],28:[function(require,module,exports){
/*!
...
},{"min-document":61}],33:[function(require,module,exports){
"use strict";
...
},{"../vnode/is-vhook.js":48,"is-object":33}],36:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":46,"../vnode/is-vnode.js":49,"../vnode/is-vtext.js":50,"../vnode/is-widget.js":51,"./apply-properties":35,"global/document":32}],37:[function(require,module,exports){
...
},{"../vnode/is-widget.js":51,"../vnode/vpatch.js":54,"./apply-properties":35,"./update-widget":40}],39:[function(require,module,exports){
var document = require("global/document")
...
},{"./create-element":36,"./dom-index":37,"./patch-op":38,"global/document":32,"x-is-array":58}],40:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"../vnode/is-widget.js":51}],41:[function(require,module,exports){
'use strict';
...
},{"browser-split":28}],45:[function(require,module,exports){
'use strict';
...
},{"./src/app":64,"@cycle/core":60,"@cycle/dom":1}],60:[function(require,module,exports){
"use strict";
...
},{"rx":63}],61:[function(require,module,exports){
